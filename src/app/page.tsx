    ...
    <>
      ...
      <aside className="w-[260px] h-screen fixed left-0 top-0 bg-surface flex flex-col py-8 px-4 border-r border-outline-variant z-50 hidden md:flex">
        <div className="mb-12 px-4">
          <h1 className="text-headline-sm font-headline-sm text-primary" data-testid="page-title">MediData</h1>
          <p className="text-label-md font-label-md text-on-surface-variant">Enterprise MDM</p>
        </div>
        ...
        <div className="mt-auto px-4">
          <div className="bg-primary-container p-4 rounded-xl text-on-primary-container relative overflow-hidden group cursor-pointer">
            <div className="relative z-10">
              <p className="font-label-md text-label-md mb-1 opacity-90">Enterprise Pro</p>
              <p className="font-headline-sm text-headline-sm mb-3">Upgrade Plan</p>
      ...
      <div className="flex-1 h-screen overflow-y-auto bg-background md:ml-[260px] flex flex-col">
        ...
        <header className="h-20 fixed top-0 right-0 left-0 md:left-[260px] z-40 bg-surface/80 backdrop-blur-md flex justify-between items-center px-gutter border-b border-outline-variant">
          <div className="flex items-center gap-8">
            <h2 className="font-headline-md text-headline-md text-on-surface">Master Data Management</h2>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-outline-variant">
              <div className="text-right">
                <p className="font-label-md text-label-md text-on-surface font-semibold">Dr. Sarah Chen</p>
                <p className="font-label-md text-[10px] text-on-surface-variant">System Administrator</p>
              </div>
              <img
        ...
        <main className="mt-20 p-container-padding flex-1">
          ...
          <section className="grid grid-cols-12 gap-gutter mb-8">
            <div className="col-span-12 lg:col-span-8 bg-secondary-container/20 rounded-2xl p-8 flex justify-between items-center relative overflow-hidden border border-secondary-container/30">
              <div className="max-w-xl z-10">
                <h3 className="font-headline-lg text-headline-lg text-on-secondary-container mb-2">Northwestern Memorial Hospital</h3>
                ...
                <div className="flex gap-6">
                  <div className="flex items-center gap-3 bg-white/60 backdrop-blur rounded-xl p-3 border border-white/40">
                    ...
                    <div>
                      <p className="text-label-md text-on-surface-variant font-medium">Total Doctors</p>
                      <p className="text-headline-sm font-headline-sm text-on-surface">3.8k</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 bg-white/60 backdrop-blur rounded-xl p-3 border border-white/40">
                    ...
                    <div>
                      <p className="text-label-md text-on-surface-variant font-medium">Facilities</p>
                      <p className="text-headline-sm font-headline-sm text-on-surface">21</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-span-12 lg:col-span-4 bg-white rounded-2xl p-8 custom-shadow border border-outline-variant flex flex-col items-center justify-center text-center">
              <h4 className="font-headline-sm text-headline-sm mb-6 text-on-surface">System Health Score</h4>
              <div className="gauge-container mb-4">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-stat-value font-stat-value text-primary leading-tight">89%</span>
                  <span className="text-[10px] font-bold text-on-surface-variant uppercase tracking-wider">Optimal</span>
                </div>
              </div>
              <p className="text-body-md font-body-md text-on-surface-variant">System performance is exceeding target by 4.2% this week.</p>
            </div>
          </section>
          ...
          <section className="grid grid-cols-12 gap-gutter mb-8">
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-3 bg-white p-6 rounded-2xl border border-outline-variant custom-shadow hover:scale-[1.02] active:scale-[0.98] transition-transform duration-200 cursor-default group">
              ...
              <p className="font-stat-value text-stat-value text-on-surface">24,500</p>
              <p className="font-body-md text-body-md text-on-surface-variant">Registered Patients</p>
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-3 bg-white p-6 rounded-2xl border border-outline-variant custom-shadow hover:scale-[1.02] active:scale-[0.98] transition-transform duration-200 cursor-default group">
              ...
              <p className="font-stat-value text-stat-value text-on-surface">18,200</p>
              <p className="font-body-md text-body-md text-on-surface-variant">Medical Supplies</p>
              <div className="mt-4 pt-4 border-t border-surface-container border-dashed">
                <div className="flex justify-between text-[10px] text-on-surface-variant font-bold uppercase tracking-widest">
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-3 bg-white p-6 rounded-2xl border border-outline-variant custom-shadow hover:scale-[1.02] active:scale-[0.98] transition-transform duration-200 cursor-default group">
              ...
              <p className="font-stat-value text-stat-value text-on-surface">3,400</p>
              <p className="font-body-md text-body-md text-on-surface-variant">Care Providers</p>
              <div className="mt-4 pt-4 border-t border-surface-container border-dashed">
                <div className="flex justify-between text-[10px] text-on-surface-variant font-bold uppercase tracking-widest">
            ...
            <div className="col-span-12 md:col-span-6 lg:col-span-3 bg-on-primary-fixed-variant p-6 rounded-2xl border border-outline-variant custom-shadow hover:scale-[1.02] active:scale-[0.98] transition-transform duration-200 cursor-default group">
              ...
              <p className="font-body-md text-body-md text-white/70">Beds Available</p>
          ...
          <section className="grid grid-cols-12 gap-gutter mb-8">
            ...
            <div className="col-span-12 lg:col-span-8 bg-white p-8 rounded-2xl border border-outline-variant custom-shadow">
              <div className="flex justify-between items-center mb-10">
                <div>
                  <h4 className="font-headline-sm text-headline-sm text-on-surface">Data Integrity Trend</h4>
                  <p className="text-body-md text-on-surface-variant">Monthly MDM governance improvement tracking</p>
                </div>
                <div className="flex gap-2">
                  <button className="px-3 py-1 bg-surface-container text-on-surface-variant rounded-full text-label-md font-bold hover:bg-surface-container-high transition-colors">12M</button>
                  <button className="px-3 py-1 bg-primary text-white rounded-full text-label-md font-bold hover:bg-on-primary-fixed-variant transition-colors">6M</button>
                  <button className="px-3 py-1 bg-surface-container text-on-surface-variant rounded-full text-label-md font-bold hover:bg-surface-container-high transition-colors">30D</button>
                </div>
              </div>
              {/* Mock Chart Area */}
              <div className="relative h-[300px] w-full mt-4">
                <svg className="w-full h-full overflow-visible" preserveAspectRatio="none">
                  ...
                  {/* Smoothed Path */}
                  <path d="M 0 240 Q 150 200 300 230 T 600 150 T 900 120 T 1200 80" fill="none" stroke="#4648d4" strokeLinecap="round" strokeWidth="3"></path>
                  <path d="M 0 240 Q 150 200 300 230 T 600 150 T 900 120 T 1200 80 V 300 H 0 Z" fill="url(#chartGradient)"></path>
                  {/* Data Points */}
                  ...
                  <circle cx="1180" cy="85" fill="#4648d4" r="5" stroke="white" strokeWidth="2"></circle>
                </svg>
            ...
            <div className="col-span-12 lg:col-span-4 bg-white p-8 rounded-2xl border border-outline-variant custom-shadow flex flex-col">
              <h4 className="font-headline-sm text-headline-sm text-on-surface mb-6">Recent Activity</h4>
              <div className="flex-1 space-y-6 overflow-y-auto max-h-[300px] pr-2">
                ...
                <div className="flex gap-4 relative">
                  ...
                  <div className="flex-1">
                    <p className="font-body-md text-body-md text-on-surface"><span className="font-bold">MDM Protocol Updated</span></p>
                    <p className="text-label-md text-on-surface-variant">Cardiology patient records synchronized across 4 nodes.</p>
                    <p className="text-[10px] text-outline font-bold mt-1 uppercase">2 MINS AGO</p>
                  </div>
                ...
                <div className="flex gap-4 relative">
                  ...
                  <div className="flex-1">
                    <p className="font-body-md text-body-md text-on-surface"><span className="font-bold">System Backup Completed</span></p>
                    <p className="text-label-md text-on-surface-variant">Encrypted archive generated for 1.4TB of telemetry data.</p>
                    <p className="text-[10px] text-outline font-bold mt-1 uppercase">2 HOURS AGO</p>
                  </div>
                  <div className="absolute left-5 top-10 bottom-[-24px] w-[1px] bg-outline-variant"></div>
                </div>
                {/* Activity Item 4 */}
          ...
          <section className="grid grid-cols-12 gap-gutter">
            ...
            <div className="col-span-12 lg:col-span-5 bg-white p-8 rounded-2xl border border-outline-variant custom-shadow flex flex-col">
              <h4 className="font-headline-sm text-headline-sm text-on-surface mb-2">ETL Pipeline Intake</h4>
              <p className="text-body-md text-on-surface-variant mb-6">Upload healthcare master data to trigger standardization and ingestion pipeline.</p>
              ...
              >
                ...
                <p className="text-[11px] text-on-surface-variant text-center max-w-xs">
                  Drag and drop CSV files here, or <span className="text-primary font-bold hover:underline">browse</span>. Max 500MB.
                </p>
              </div>
              ...
              <div className="flex items-center justify-between gap-4 mt-auto">
                ...
                {message && (
                  <p className={`text-label-md font-semibold truncate ${message.includes('success') || message.includes('successful') ? 'text-tertiary' : 'text-error'}`}>
                    {message}
                  </p>
                )}
              </div>
            ...
            <div className="col-span-12 lg:col-span-7 bg-white p-8 rounded-2xl border border-outline-variant custom-shadow flex flex-col">
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h4 className="font-headline-sm text-headline-sm text-on-surface">Harmonized Records</h4>
                  <p className="text-body-md text-on-surface-variant font-medium">Standardized healthcare master data entities</p>
                </div>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-outline-variant">
                      <th className="py-3 px-4 text-label-md text-on-surface-variant font-bold uppercase tracking-wider">ID</th>
                      <th className="py-3 px-4 text-label-md text-on-surface-variant font-bold uppercase tracking-wider">Name</th>
                      <th className="py-3 px-4 text-label-md text-on-surface-variant font-bold uppercase tracking-wider">Category</th>
                      <th className="py-3 px-4 text-label-md text-on-surface-variant font-bold uppercase tracking-wider text-right">Value</th>
                    </tr>
                  </thead>
                  <tbody className="text-body-md text-on-surface divide-y divide-outline-variant/30">
                    {data.length === 0 ? (
                      <tr>
                        <td className="px-4 py-8 text-center text-on-surface-variant" colSpan={4}>
                      ...
                      data.map((row, index) => (
                        <tr key={index} className="hover:bg-surface-container-low/50 transition-colors">
                          <td className="py-3 px-4 font-semibold text-primary">{row.id || `REC-${index}`}</td>
                          ...
                          <td className="py-3 px-4 text-right font-bold text-tertiary">{row.value}</td>
                        </tr>
                      ))
                    )}
                  </tbody>
